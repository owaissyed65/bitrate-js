...
> See [PLAN.md](https://github.com/owaissyed65/bitrate-js/blob/main/PLAN.md) for the roadmap and [SECURITY.md](https://github.com/owaissyed65/bitrate-js/blob/main/SECURITY.md) for the security model.
...
people usually miss — is in **[ADAPTERS.md](https://github.com/owaissyed65/bitrate-js/blob/main/ADAPTERS.md)**.

Full security model in [SECURITY.md](https://github.com/owaissyed65/bitrate-js/blob/main/SECURITY.md): path-traversal defence, untrusted-input
